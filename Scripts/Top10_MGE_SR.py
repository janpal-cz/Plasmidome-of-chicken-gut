...
def kma_res(res_table):
	...
	for line in lines[1:]:
		ID.append(line.split("\t")[0].split('|')[0])
...
def kma_mapstat(mapstat_table, sampel):
	...
	with open('/media/ja/data/Mikra/Jane/plasmidome/new/Results/all_top10_MGE_combined_SR.txt', 'a') as data:
...
def top10_rpkms(ID_RPKM_pair, sampl):
	...
	genes_sum = '/media/ja/data/Mikra/Jane/plasmidome/new/Results/sum_genes_MGE_SR.txt'
...
H1_13d = kma_res("/media/ja/data/Mikra/Jane/plasmidome/new/Short-read/trimmed/02F_mge.res")
H1_20d = kma_res("/media/ja/data/Mikra/Jane/plasmidome/new/Short-read/trimmed/03F_mge.res")
H1_27d = kma_res("/media/ja/data/Mikra/Jane/plasmidome/new/Short-read/trimmed/04F_mge.res")
H1_35d = kma_res("/media/ja/data/Mikra/Jane/plasmidome/new/Short-read/trimmed/05F_mge.res")
H2_10d = kma_res("/media/ja/data/Mikra/Jane/plasmidome/new/Short-read/trimmed/07F_mge.res")
H2_17d = kma_res("/media/ja/data/Mikra/Jane/plasmidome/new/Short-read/trimmed/08F_mge.res")
H2_24d = kma_res("/media/ja/data/Mikra/Jane/plasmidome/new/Short-read/trimmed/09F_mge.res")
H2_31d = kma_res("/media/ja/data/Mikra/Jane/plasmidome/new/Short-read/trimmed/10F_mge.res")
H3_9d = kma_res("/media/ja/data/Mikra/Jane/plasmidome/new/Short-read/trimmed/12F_mge.res")
H3_16d = kma_res("/media/ja/data/Mikra/Jane/plasmidome/new/Short-read/trimmed/13F_mge.res")
H3_23d = kma_res("/media/ja/data/Mikra/Jane/plasmidome/new/Short-read/trimmed/14F_mge.res")
H3_30d = kma_res("/media/ja/data/Mikra/Jane/plasmidome/new/Short-read/trimmed/15F_mge.res")
...
with open('/media/ja/data/Mikra/Jane/plasmidome/new/Results/all_top10_MGE_combined_SR.txt', 'w') as data:
...
H1_13_numread_pair, H1_13_totalLength = kma_mapstat("/media/ja/data/Mikra/Jane/plasmidome/new/Short-read/trimmed/02F_mge.mapstat", 'H1_13')
H1_20_numread_pair, H1_20_totalLength = kma_mapstat("/media/ja/data/Mikra/Jane/plasmidome/new/Short-read/trimmed/03F_mge.mapstat", 'H1_20')
H1_27_numread_pair, H1_27_totalLength = kma_mapstat("/media/ja/data/Mikra/Jane/plasmidome/new/Short-read/trimmed/04F_mge.mapstat", 'H1_27')
H1_35_numread_pair, H1_35_totalLength = kma_mapstat("/media/ja/data/Mikra/Jane/plasmidome/new/Short-read/trimmed/05F_mge.mapstat", 'H1_35')

H2_10_numread_pair, H2_10_totalLength = kma_mapstat("/media/ja/data/Mikra/Jane/plasmidome/new/Short-read/trimmed/07F_mge.mapstat", 'H2_10')
H2_17_numread_pair, H2_17_totalLength = kma_mapstat("/media/ja/data/Mikra/Jane/plasmidome/new/Short-read/trimmed/08F_mge.mapstat", 'H2_17')
H2_24_numread_pair, H2_24_totalLength = kma_mapstat("/media/ja/data/Mikra/Jane/plasmidome/new/Short-read/trimmed/09F_mge.mapstat", 'H2_24')
H2_31_numread_pair, H2_31_totalLength = kma_mapstat("/media/ja/data/Mikra/Jane/plasmidome/new/Short-read/trimmed/10F_mge.mapstat", 'H2_31')


H3_9_numread_pair, H3_9_totalLength = kma_mapstat("/media/ja/data/Mikra/Jane/plasmidome/new/Short-read/trimmed/12F_mge.mapstat", 'H3_9')
H3_16_numread_pair, H3_16_totalLength = kma_mapstat("/media/ja/data/Mikra/Jane/plasmidome/new/Short-read/trimmed/13F_mge.mapstat", 'H3_16')
H3_23_numread_pair, H3_23_totalLength = kma_mapstat("/media/ja/data/Mikra/Jane/plasmidome/new/Short-read/trimmed/14F_mge.mapstat", 'H3_23')
H3_30_numread_pair, H3_30_totalLength = kma_mapstat("/media/ja/data/Mikra/Jane/plasmidome/new/Short-read/trimmed/15F_mge.mapstat", 'H3_30')
...
summary_genes = '/media/ja/data/Mikra/Jane/plasmidome/new/Results/sum_genes_MGE_SR.txt'
with open(summary_genes, 'w') as file:
	file.write('Sorted genes of all samples\n')
...
def visualise_barh(house_data, house_labels):
	...
	fig.suptitle(f"Top 10 identified mobile genetic elements in metagenomic data")
	plt.tight_layout(rect=[0, 0, 1, 0.96])
	plt.savefig(f"/media/ja/data/Mikra/Jane/plasmidome/new/Results/combined_top10_hbar_MGE_SR.svg")
