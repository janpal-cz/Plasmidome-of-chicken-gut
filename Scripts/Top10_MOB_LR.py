...
def kma_mapstat(mapstat_table, sampel):
	...
	with open('/media/ja/data/Mikra/Jane/plasmidome/new/Results/all_top10_MOB_combined.txt', 'a') as data:
...
def cov80(ids, covs, identity, lengths):
	...
	list80_sum = '/media/ja/data/Mikra/Jane/plasmidome/new/Results/sum_list80_MOB_all.txt'
...
def top10_rpkms(ID_RPKM_pair, sampl):
	...
	genes_sum = '/media/ja/data/Mikra/Jane/plasmidome/new/Results/sum_genes_MOB_all.txt'
...
with open('/media/ja/data/Mikra/Jane/plasmidome/new/Results/all_top10_MOB_combined.txt', 'w') as data:
...
summary_genes = '/media/ja/data/Mikra/Jane/plasmidome/new/Results/sum_genes_MOB_all.txt'
...
def visualise_barh(house_data, house_labels):
	...
	fig.suptitle(f"Top 10 identified types of plasmids based on their MOB type")
	plt.tight_layout(rect=[0, 0, 1, 0.96])
	plt.savefig(f"/media/ja/data/Mikra/Jane/plasmidome/new/Results/combined_top10_hbar_MOB.svg")
