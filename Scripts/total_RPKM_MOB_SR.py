...
def kma_mapstat(mapstat_table, sampel):
	...
	with open('/media/ja/data/Mikra/Jane/plasmidome/new/Results/all_totalRPKM_MOB_SR.txt', 'a') as data:
...
with open('/media/ja/data/Mikra/Jane/plasmidome/new/Results/all_totalRPKM_MOB_SR.txt', 'w') as data:
...
def visualise_bar(house_data, house_labels):
	...
	plt.savefig(f"/media/ja/data/Mikra/Jane/plasmidome/new/Results/combined_total_RPKM_MOB_SR.svg")
