...
def kma_mapstat(mapstat_table, sampel):
	...
	with open('/media/ja/data/Mikra/Jane/plasmidome/new/Results/all_groups_MOB_specific_LR.txt', 'a') as data:
...
def cov80(ids, covs, identity, lengths, sampel):
	...
	with open('/media/ja/data/Mikra/Jane/plasmidome/new/Results/all_groups_MOB_specific_LR.txt', 'w') as data:
...
def sort_AMR_groups(RPKM_list, cov80_id_list, total, samp):
    ...
    for group, value in zip(group_list[0], group_list[1]):
    	with open('/media/ja/data/Mikra/Jane/plasmidome/new/Results/final_info_groups_MOB_LR.txt', 'a') as table:
...
with open('/media/ja/data/Mikra/Jane/plasmidome/new/Results/final_info_groups_MOB_LR.txt', 'w') as table:
...
color_mapping = {
	'KU254578|MOBP': '#ffe9f0',
	'NZ_CP011595|MOBP': '#A6C2C0',
	'JN985534|MOB_unknown': '#eec5b7',
	'CP016748|MOBQ': '#ea9999',
	'KY014464|MOBP': '#FFE69F',
	'NC_011990|MOBP': '#ffe3c0',
	'CP001386|MOBP': '#FFABAB',
	'KU932034|MOB_unknown': '#d2d7e7',
	'NC_019078|MOBP': '#C78BA5',
	'NC_018997|MOBP': '#cfe2f3',
	'GQ900404|MOB_unknown': '#ffcebe',
	'CP022165|MOBP': '#d9ead3',
	'AB027308|MOBP': '#b4a7d6',
	'KF992024|MOBP': '#dda298',
	'CP018844|MOBP': '#84D6B3',
	'CP018223|MOBP': '#B8DECC',
	'NC_002145|MOBP': '#d5a6bd',
	'CP018359|MOB_unknown': '#dfbac9',
	'CP007658|MOBP': '#9edae5',
	'CP019195|MOBP': '#BCBD22'
	}
...
def visualisation_combined_bar(info_names, data_sets, time_labels):
	...
	plt.title("Relative abundance of MOB groups in plasmidome")
	plt.xticks(x, xtick_labels, rotation=45, ha='right')
	plt.legend(loc='center left', bbox_to_anchor=(1, 0.5))
	plt.tight_layout()

	plt.savefig(f"/media/ja/data/Mikra/Jane/plasmidome/new/Results/combined_plot_MOB_LR_final.svg")
