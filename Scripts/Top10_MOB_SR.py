...
def kma_mapstat(mapstat_table, sampel):
	...
	with open('/media/ja/data/Mikra/Jane/plasmidome/new/Results/all_top10_MOB_combined_SR.txt', 'a') as data:
...
def top10_rpkms(ID_RPKM_pair, sampl):
	...
	genes_sum = '/media/ja/data/Mikra/Jane/plasmidome/new/Results/sum_genes_MOB_SR.txt'
...
with open('/media/ja/data/Mikra/Jane/plasmidome/new/Results/all_top10_MOB_combined_SR.txt', 'w') as data:
...
summary_genes = '/media/ja/data/Mikra/Jane/plasmidome/new/Results/sum_genes_MOB_SR.txt'
...
def visualise_barh(house_data, house_labels):
	...
	plt.savefig(f"/media/ja/data/Mikra/Jane/plasmidome/new/Results/combined_top10_hbar_MOB_SR.svg")
